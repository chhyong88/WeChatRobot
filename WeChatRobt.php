...
发送 help 可以获得帮助. /::)
发送 img 可看到网站预览图./:ladybug
发送 news 可看图片新闻./:gift
发送 music 可听音乐./:sun

当然也可以发送其他关键字来查看是否能获得您想要的信息./:share
您还可以给我发语音,位置,图片等./:#-0
您也可以给我提 建议. /:hug
快来跟我聊天.../:pig
";
    ...
    private function receiveText($object)
    {
        ...
        //自动回复模式
        	if (strstr($keyword, "超人") || strstr(strtolower($keyword), "superman"))
            {
                $content = "超人来了/:<O>,是您在呼唤我吗？ 请问客官需要来点啥？ 您可以输入 上菜 . 看看我们给您准备了些什么...";
            }else if(strstr($keyword, "菜"))
            {
            	$content = "
/:eat
蒸羊羔,蒸熊掌,蒸鹿尾儿, 
...
客官，/:pig您吃饱了吗？
";
            }else if(strstr(strtolower($keyword), "help") || strstr($keyword, "帮助"))
            {
            	$content = "
您好，我是一个机器人./:heart 
很乐意为您效劳./:,@P 
...
快来跟我聊天.../:pig
";
            }else if (strstr(strtolower($keyword), "img") || strstr($keyword, "图片"))
            {
                $content = array();
                $content[] = array("Title"=>"全站工程师首页",  "Description"=>"全端工程师首页---这是主人设计的网站", "PicUrl"=>"http://blog.79kg.com/front/front1.png", "Url" =>"http://79kg.com");
            ...
            }else if (strstr(strtolower($keyword), "music") || strstr($keyword, "音乐"))
            {
                $content = array();
                $content = array("Title"=>"平凡之路", "Description"=>"歌手：朴树", "MusicUrl"=>"http://qzone.haoduoge.com/up/6/MjcxNTc1MDU=.mp3", "HQMusicUrl"=>"http://qzone.haoduoge.com/up/6/MjcxNTc1MDU=.mp3");
            }else if(strstr($keyword, "您好") || strstr($keyword, "你好") || strstr($keyword, "在吗") || strstr($keyword, "谁"))
            {
            	$content = "
您好！我是主人打造出来的机器人,当然您可以叫我超人/::>,有什么可以为您效劳的.
";
            }else if(strstr($keyword, "玩") || strstr($keyword, "逗") || strstr($keyword, "笑"))
            {
            	$content = "
您好！能为您服务我也很开心.
";
            }else if(strstr($keyword, "程序") || strstr($keyword, "开发") || strstr($keyword, "软件"))
            {
            	$content = "
哈！我主人就是程序员.
";
            }else if(strstr($keyword, "黄广志"))
            {
            	$content = "
您认识我主人？.
";
...
";
            ...
            {
            	$content = "
您发送的是表情吗？我不理解人类的表情...您可以输入 help 来获取与我沟通的技巧.
";
...
好孩子都是不说脏话的,您应该向我学习.
";
            }else if(strstr($keyword, "是") || strstr($keyword, "不") )
            {
            	$content = "
是不是，您说了算.
";
            }else if(strstr($keyword, "你") || strstr($keyword, "您") )
            {
            	$content = "
我是机器人,您可以叫我超人.
";
            }else if(strstr($keyword, "饿") || strstr($keyword, "疼")|| strstr($keyword, "困") )
            {
            	$content = "
客官,您要照顾好自己啊！饿了就吃，累了就睡.
";
            }else if(strstr($keyword, "再见") || strstr($keyword, "bye")|| strstr($keyword, "晚安")|| strstr($keyword, "白白")|| strstr($keyword, "拜") )
            {
            	$content = "
客官,慢走.欢迎您下次再来,我会想你的.
";
            }else if(strstr($keyword, "来") || strstr($keyword, "我")|| strstr($keyword, "看")|| strstr($keyword, "聊")|| strstr($keyword, "说") )
            {
            	$content = "
客官,你来了!快来和我聊天吧！如果不知道说什么？输入 help 获取提示.
";
            }else if(strstr($keyword, "啊") || strstr($keyword, "恩")|| strstr($keyword, "嗯")|| strstr($keyword, "吧")|| strstr($keyword, "哦") )
            {
            	$content = "
客官,我感觉您好像有心事,是开心还是不开心,说出来吧！.
";
            }else if(strstr($keyword, "胖") || strstr($keyword, "瘦")|| strstr($keyword, "矮")|| strstr($keyword, "穷")|| strstr($keyword, "挫") )
            {
            	$content = "
人生就是笑笑别人,在笑笑自己,身体健康最重要,开心过好每一天.
";
            }else if(strstr($keyword, "白") || strstr($keyword, "富")|| strstr($keyword, "美")|| strstr($keyword, "高")|| strstr($keyword, "帅") )
            {
            	$content = "
客官,也算女人中的白富美,男人中的高富帅.
";
            }else if(strstr($keyword, "烦") || strstr($keyword, "糟")|| strstr($keyword, "不好")|| strstr($keyword, "心情")|| strstr($keyword, "爽") )
            {
            	$content = "
您心情不好,和我聊聊,我希望您每天都开心.
";
            }
            
            else if(strstr($keyword, "天气") )
            {
                $code=$this->check(mb_substr($keyword , 0 , 2 , 'utf-8'));
                $getcontent = file_get_contents("http://www.weather.com.cn/data/cityinfo/{$code}.html");
if(!$getcontent){
...
$content .= "最高温度:{$info['temp2']}\n";
            ...
            else if(strstr(strtolower($keyword), "a") || strstr(strtolower($keyword), "b") || strstr(strtolower($keyword), "c")|| strstr(strtolower($keyword), "d")|| strstr(strtolower($keyword), "e")|| strstr(strtolower($keyword), "f") || strstr(strtolower($keyword), "g") || strstr(strtolower($keyword), "h") || strstr(strtolower($keyword), "i") || strstr(strtolower($keyword), "j") || strstr(strtolower($keyword), "k") || strstr(strtolower($keyword), "l") || strstr(strtolower($keyword), "m") || strstr(strtolower($keyword), "n") || strstr(strtolower($keyword), "o") || strstr(strtolower($keyword), "p") || strstr(strtolower($keyword), "q") || strstr(strtolower($keyword), "r") || strstr(strtolower($keyword), "s") || strstr(strtolower($keyword), "t") || strstr(strtolower($keyword), "u") || strstr(strtolower($keyword), "v") || strstr(strtolower($keyword), "w") || strstr(strtolower($keyword), "x") || strstr(strtolower($keyword), "y") || strstr(strtolower($keyword), "z"))
            {
            	$content = "
您是想说26个英文字母吗？ABCDEFGHIJKLMNOPQRSTUVWXYZ.
";
            }else if(strstr($keyword, "0") || strstr($keyword, "1") || strstr($keyword, "2")|| strstr($keyword, "3")|| strstr($keyword, "4")|| strstr($keyword, "5")|| strstr($keyword, "6")|| strstr($keyword, "7")|| strstr($keyword, "8")|| strstr($keyword, "9"))
            {
            	$content = "
我会数数,但是我不会计算,我应该是最笨的机器人了.
";
            }else if(strstr($keyword, "，") || strstr($keyword, "。")|| strstr($keyword, "！")|| strstr($keyword, ",")|| strstr($keyword, ".") )
            {
            	$content = "
您无话可说了？输入 help 获取提示.
";
                ...
                $content = "当前时间:".date("Y-m-d H:i:s",time())."\n 您发送的内容 # ".$object->Content." # \n \n 把我难住了/:fade. 我会努力向您学习,继续为您服务！ 请多指教！/:@)";
            }
    ...
    private function check($str){
		...
		if (in_array($str, $this->arr)) {
			return array_search($str, $this->arr);
		}else {
            //默认北京天气
			return 101010100;
		}
